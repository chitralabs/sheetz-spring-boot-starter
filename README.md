...
**Gradle:**
```groovy
implementation 'io.github.chitralabs.sheetz:sheetz-spring-boot-starter:1.1.0'
...
- [sheetz-core](https://central.sonatype.com/artifact/io.github.chitralabs.sheetz/sheetz-core) 1.1.0
